...
import app.adinfinitum.ello.data.IRepoPrenumberAndWebApiVer
...
class AboutFragmentViewModel (val myRepoPrenumberAndWebApiVer: IRepoPrenumberAndWebApiVer, application: Application) : AndroidViewModel(application) {
